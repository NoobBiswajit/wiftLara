          ...
          <div class="grid grid-cols-12 lg:pt-0 pt-12">
            <div class="lg:col-span-6 col-span-12 flex justify-center">
              <div class="relative lg:top-32 top-0">
                <p
                  class="font-rlw font-semibold lg:text-4xl text-2xl lg:text-justify text-center"
                >
                  Join Us
                  <iconify-icon
                    icon="ion:play-back"
                ...
                <h2
                  class="font-rlw font-bold text-black lg:text-9xl text-4xl lg:text-justify text-center"
                >
                  NEXWIFT
                </h2>
                <p
                  class="font-rlw font-medium text-black lg:text-2xl text-xl lg:text-justify text-center"
                >
            ...
            <div class="lg:col-span-6 col-span-12">
              <div class="flex lg:justify-end justify-center">
                <img
                  src="./img/joinUs-removebg-preview.png"
                  alt=""
          ...
          <div class="grid grid-cols-12 gap-5">
            <div class="lg:col-span-6 col-span-12 lg:mx-0 mx-2">
              <div class="pt-12 pb-3">
                <h2
                  class="font-rlw font-bold text-black lg:text-6xl text-3xl w-full text-center"
                >
              ...
              <div class="grid grid-cols-6 gap-2 py-6">
                <div class="col-span-3">
                  <div class="bg-white rounded-md my-2 hover:bg-slate-300 py-6">
                    ...
                    <div class="">
                      <h2
                        class="font-rlw font-semibold text-black lg:text-xl text-base text-center"
                      >
            ...
            <div class="lg:col-span-6 col-span-12">
              <div class="pb-10">
                <div class="lg:pt-12 pb-6">
                  <h2
                    class="font-rlw font-bold text-black lg:text-5xl text-3xl text-center"
                  >
                ...
                <div class="lg:px-20 px-5 h-auto">
                  <p
                    class="font-rlw font-normal text-black lg:text-2xl text-base text-center"
                  >
      ...
      <div class="pb-10">
        <div class="container mx-auto">
          ...
          <div class="grid grid-cols-12">
            <div
              class="lg:col-span-8 col-span-12 jobs rounded-2xl lg:p-8 p-4 bg-white hover:border-2"
            >
              <a href="" class="lg:m-3 m-1">
                ...
                >
                  <div class="">
                    <h2
                      class="font-rlw lg:font-semibold font-normal text-center"
                    >
                      Front-End Developer
                    </h2>
                  </div>
            ...
            <div class="lg:col-span-4 col-span-12 lg:block hidden">
              <div class="">
                <img src="./img/vacancy-removebg-preview.png" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-12">
              ...
              <div class="lg:hidden block">
                <div class="flex flex-col justify-center">
                  <div class="lg:pb-10 pb-2 lg:pt-0 pt-5">
                    <h2
                      class="font-rlw font-bold text-black lg:text-4xl text-2xl w-full text-center"
                    >
                      <span class="text-red-600">Steps</span> to Join the Camp
                    </h2>
                  </div>
                  <div class="flex justify-center">
                    <img src="./img/recruit-removebg-preview.png" alt="" />
                  </div>
                  <div class="">
                    <p
                      class="font-rlw font-medium lg:text-2xl text-lg lg:text-start text-center px-3"
                    >
                    ...
                    <div class="direction-r hover:shadow-2xl p-6 rounded-xl">
                      <div class="flag-wrapper">
                        ...
                        <span class="time-wrapper"
                          ><span class="time text-base">Step 1</span></span
                        >
                      </div>
                  ...
                  <li>
                    <div class="direction-l hover:shadow-2xl p-6 rounded-xl">
                      <div class="flag-wrapper">
                        ...
                        <span class="time-wrapper"
                          ><span class="time text-base">Step 2</span></span
                        >
                      </div>
                      <div class="desc text-xl">
                  ...
                  <li>
                    <div class="direction-r hover:shadow-2xl p-6 rounded-xl">
                      <div class="flag-wrapper">
                        ...
                        <span class="time-wrapper"
                          ><span class="time text-base">Step 3</span></span
                        >
                      </div>
                      <div class="desc text-xl">
                  ...
                  <li>
                    <div class="direction-l hover:shadow-2xl p-6 rounded-xl">
                      <div class="flag-wrapper">
                        ...
                        <span class="time-wrapper"
                          ><span class="time text-base">Step 4</span></span
                        >
                      </div>
                      <div class="desc text-xl">
                  ...
                  <li>
                    <div class="direction-r hover:shadow-2xl p-6 rounded-xl">
                      <div class="flag-wrapper">
                        ...
                        <span class="time-wrapper"
                          ><span class="time text-base">Step 5</span></span
                        >
                      </div>
                      <div class="desc text-xl">
            ...
            <div class="lg:col-span-4 col-span-12 flex flex-col justify-center">
              <div class="lg:block hidden">
                <div class="pb-10">
                  <h2
                    class="font-rlw font-bold text-black text-4xl w-full text-center"
                  >
