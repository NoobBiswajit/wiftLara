                    ...
                    <div class="grid grid-cols-2 gap-10">
                            <div class="">
                                ...
                                <div class="border-b border-b-Nblue">
                                    <input class="focus:outline-none px-3 font-rlw text-lg font-medium placeholder:text-Nblue bg-transparent  w-full "
                                        type="text">
                                </div>
                            </div>
                            <div class="">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <div class="">
                                    <a href="trems.html"
                                    class=" text-base text-Nblue font-rlw underline  hover:text-green-500 underline-offset-4">Agree to Terms and
                                        Condition</a>
                                </div>
                            </div>
                            <div class="flex gap-3 items-center justify-end">
                                <div class="">
                                    <a href="signin.html"
                                    class=" text-base text-Nblue font-rlw  hover:text-green-500 ">Already have an account ?</a>
                                </div>
                            </div>
                        </div>
                            <div class="mt-5">
                                <button class=" bg-Nblue font-rlw text-base text-white py-2 w-full hover:bg-dred ">Create Account</button>
                            </div>
                        </form>
                    </div>
                </div>
